# Chú Thích Chi Tiết Ảnh Chụp Màn Hình Minh Chứng Nghiệp Vụ

Tài liệu này thuyết minh chi tiết cho **12 ảnh chụp màn hình** lưu trữ trong thư mục [minh_chung/](file:///c:/Users/Nguyen%20Trong%20Khoi/Downloads/HQTSCDL_DA/library_oracle_hqtcsdl/minh_chung), chia thành các kịch bản thao tác đúng (Success) và thao tác lỗi ràng buộc (Error) cho 6 nghiệp vụ thư viện từ B1 đến B6.
